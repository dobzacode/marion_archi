...
export default function DesignMenu({}) {
  ...
  return (
    <div className="slideInFromRight absolute left-0 h-[40rem] w-full overflow-hidden border-opacity-10   bg-primary99  tablet:h-1/2">
      <nav className="h-full">
        <ul className="flex h-full flex-col tablet:block">
          ...
          <li className="h-full">
            <MenuButton
              customHighlight=" before:h-[90%] before:w-[78vw] before:min-[645px]:w-[100%] tablet:before:w-[42vw] min-[1300px]:before:w-[40vw] before:rotate-[-2deg] max-[1300px]:before:left-[10px] min-[1300px]:before:left-[16px]"
