...
export default function CvSection() {
  return (
    <section className="flex h-screen flex-col">
      ...
      <div className=" relative block h-full w-full max-[1298px]:translate-y-96 max-laptop:flex max-laptop:flex-col-reverse max-tablet:h-[55rem] min-[1298px]:translate-y-[150px]">
        <section className=" relative flex w-full translate-x-24 flex-col-reverse items-center justify-center gap-extra-large px-[10px] max-laptop:mt-large max-laptop:translate-y-[300px] max-laptop:py-extra-large max-tablet:hidden tablet:gap-small">
