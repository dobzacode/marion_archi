...
export default function DesignEspaceSection() {
  return (
    <section className="flex w-full gap-sub-extra-large px-medium py-extra-large">
      <ol className="-mt-sub-large flex w-[65rem] flex-col gap-extra-large ">
        <SubSection
          custom={0}
          title="ARCHITECTURE INTERIEURS"
          className="group ml-small flex flex-col gap-extra-small  before:top-[10%] before:content-['\2022']"
          href="/"
        >
          <svg
            viewBox="0 0 200 200"
            ...
            className={cn(
              'pointer-events-none absolute z-10  -translate-x-[150%] -translate-y-1/2 overflow-visible fill-primary1 duration-slow group-hover:translate-x-0 group-hover:fill-primary10'
            )}
          >
            <path
              ...
              transform="translate(85 120) scale(1.6, 0.8)"
            />
          </svg>
          <P
            className="relative z-20 ml-small max-h-0 opacity-0 duration-slowest group-hover:max-h-[40rem] group-hover:opacity-100"
            textType="body"
          >
            <strong className="before:scale-x-0 before:bg-primary20 before:duration-medium before:group-hover:scale-x-100 group-hover:before:delay-500">
              2021/2023
            </strong>{' '}
            -<span className="underline underline-offset-2">Entreprenariat</span> <br />
            <strong className="before:rotate-[3deg] before:scale-x-0 before:bg-primary20 before:duration-medium before:group-hover:scale-x-100 group-hover:before:delay-500">
              MD architecture
            </strong>
        ...
        <SubSection
          ...
          className="group relative flex flex-col gap-extra-small  before:top-[5%] before:content-['\2022']"
          href="/"
        >
          <svg
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
            className={cn(
              'pointer-events-none absolute  z-10 -translate-x-[150%] -translate-y-1/2 overflow-visible fill-primary1 transition-all duration-slow group-hover:translate-x-0 group-hover:fill-primary10'
            )}
          >
            <path
        ...
        <SubSection
          custom={2}
          title="ARCHITECTURE"
          className="group relative  ml-large flex flex-col gap-extra-small   before:top-[10%] before:content-['\2022']"
          href="/"
        >
          <svg
            viewBox="0 0 200 200"
        ...
        <SubSection
          ...
          className="group relative  ml-sub-medium flex flex-col gap-extra-small  before:top-[10%] before:content-['\2022']"
          href="/"
        >
          {' '}
          <svg
          ...
          >
            ...
            <strong className="before:rotate-3 before:scale-x-0 before:bg-primary20 before:duration-medium before:group-hover:scale-x-100 group-hover:before:delay-500">
              AIRBUS
            </strong>{' '}
            lance un appel à projet pour laréhabilitation du batiment B42. Vainqueur.
            <br />
      ...
      <DesignEspaceTitleBlock className="relative flex w-[40rem] flex-col pt-[210px]"></DesignEspaceTitleBlock>
    </section>
  );
}
