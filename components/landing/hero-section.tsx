...
export default function HeroSection() {
  return (
    <section className=" flex w-full justify-between py-large max-[1298px]:flex-row-reverse max-[700px]:pt-extra-large tablet:h-[68rem] tablet:px-small laptop:gap-extra-large min-[1298px]:-translate-x-[5%]">
      <div className=" absolute right-0 z-10 w-[100rem] -translate-y-[10%] scale-90 max-[1298px]:w-[80rem] max-[1298px]:translate-x-[10%] max-laptop:translate-x-[20%] max-laptop:scale-90 max-tablet:top-[6%] max-tablet:-translate-y-[20%] max-tablet:scale-[83%] max-[700px]:mt-large max-[680px]:-translate-y-[25%] max-mobile-large:-left-[230px] max-[500px]:w-[70rem] min-[1298px]:right-[35vw] min-[1298px]:top-[22%]">
        <svg
