  ...
  return (
    <header className={cn(sectionVariants({ className, size, intent }))} {...props}>
      ...
      <MobileNav
        ...
        intent={textColor}
        size={size}
        className="slideInFromTop relative z-50 flex h-[1.8rem] w-full items-center justify-between bg-primary1 px-small animation-delay-[1.6s] mobile-large:gap-large mobile-large:px-medium laptop:hidden"
      ></MobileNav>
    </header>
  );
}
