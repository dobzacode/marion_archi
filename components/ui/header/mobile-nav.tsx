  ...
  return (
    <nav className={className}>
      ...
      >
        ...
        <div className="relative group duration-slow w-fit" key={v4()}>
          <svg
            viewBox="0 0 200 200"
        ...
        <div className="relative group  w-fit" key={v4()}>
          <svg
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
