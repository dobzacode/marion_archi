...
const Nav: FC<NavProps> = ({ className, linkSize, intent }) => {
  ...
  return (
    <nav className={className}>
      ...
      <ul className="laptopL:gap-large flex justify-center whitespace-nowrap tablet:gap-small laptop:gap-sub-large  overflow-visible">
        <div className="relative group duration-slow" key={v4()}>
          <svg
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
            className={cn("absolute -z-20 -translate-y-1/2 overflow-visible fill-primary1 group-hover:fill-primary20 transition-all duration-slow", pathname === '/design-d-espaces' && 'fill-primary20 -z-10')}
          >
            <path
              ...
              transform="translate(90 115) scale(1.65, 0.6)"
            />
          </svg>
          <NavLink
            rounded="small"
        ...
        <div className="relative group " key={v4()}>
          <svg
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
            className={cn("absolute -z-20 -translate-y-1/2 overflow-visible fill-primary1 group-hover:fill-tertiary20 transition-all duration-slow", pathname === '/contact' && 'fill-tertiary20 -z-10')}          
          >
            <path
